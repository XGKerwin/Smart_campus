...
public class Municipal_query_all extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Municipal_bean> municipal_beans = new Municipal_DaoImpl().query();
        JSONObject jsonObject = new JSONObject();
        if (municipal_beans != null){
            jsonObject.put("data",new JSONArray(municipal_beans));
        }
        ServletUtils.isOk(jsonObject,municipal_beans != null);
